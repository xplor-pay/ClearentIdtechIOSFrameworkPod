...
@interface ClearentBaseViewController : UIViewController
- (void)viewDidLoad;
...
typedef SWIFT_ENUM(NSInteger, ClearentResult, open) {
/// The user aborted the current flow
  ClearentResultCancelledByUser = 0,
/// No apiKey was passed to SDK
  ClearentResultApiKeyNotProvided = 1,
/// No baseURL was passed to SDK
  ClearentResultBaseURLNotProvided = 2,
/// No publicKey was passed to SDK
  ClearentResultPublicKeyNotProvided = 3,
/// Process finished
  ClearentResultProcessFinishedWithoutError = 4,
};
static NSString * _Nonnull const ClearentResultDomain = @"ClearentIdtechIOSFramework.ClearentResult";
...
/// @param completion, a closure to be executed once the clearent SDK UI is dimissed
- (UINavigationController * _Nonnull)readersViewControllerWithCompletion:(void (^ _Nullable)(enum ClearentResult))completion SWIFT_WARN_UNUSED_RESULT;
@end
