...
Pod::Spec.new do |s|
    ...
    s.vendored_frameworks = 'ClearentIdtechIOSFramework.xcframework'

    s.frameworks = 'CFNetwork', 'AudioToolbox','AVFoundation','MediaPlayer','ExternalAccessory','CocoaLumberjack.xcframework','IDTech.xcframework'
